...
/// write/read indices. `perWindowSlots` matches per-window shared buffers where
/// slot selection comes from `FrameReadyMessage.slotIndex`.
...
public final class SharedFrameBufferReader {
    ...
    ///   - layout: Memory layout used for frame slot parsing
